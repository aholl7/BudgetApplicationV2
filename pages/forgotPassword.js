              ...
              <main>
                  <Box>
                      <Box 
                          ...
                          borderRadius="3px"
                      >
                         <Text textAlign="center" fontWeight="bold" fontSize="24px">Forgot Password</Text>
                          <Text marginTop="50px">Enter the email address associated with your account and we will send you a link to reset your password.</Text>
              ...
              <main>
                  <Box>
                      <Box 
                          ...
                          border="1px solid lightgrey"
                      >
                          <Text textAlign="center" fontWeight="bold" fontSize="24px">Password Reset Email successfully sent!</Text>
                          <Box textAlign="center">
                            <Image src={SuccessImage} height={350} width={350}/>
                          </Box>
                          
                          <Text marginTop="10px">The email has successfully been sent to your email address. Once you have reset your email you can navigate back to the login page by clicking <Link href="/login"><a style={{color: "blue"}}>here</a></Link>.</Text>
